...
DOCROOT = path.abspath(path.join(path.dirname(__file__), '..'))

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': path.abspath(path.join(DOCROOT, 'db.sqlite')),                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = path.join(DOCROOT, 'media')
...
STATIC_ROOT = path.join(DOCROOT, 'static')
